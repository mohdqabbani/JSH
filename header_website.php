                    ...
                    <div class="auto-container">
                        <div class="clearfix">
                            ...
                            <div class="pull-left logo-outer">
                                <div class="logo"><a href="index.php"><img src="images/logoNew.png" alt="" title="" style="height:100px; width:200px;"></a></div>
                            </div>
                            ...
                            <nav class="main-menu">
                                ...
                                <div class="navbar-collapse collapse clearfix">
                                    <ul class="navigation clearfix">
                                        ...
                                        <li><a href="events-grid.php">Event</a>

                                        </li>
                                        <li><a href="gallery-fullwidth.php">Gallery</a>

                                        </li>
                                        <li><a href="blog-default.php">Blog</a>

                                        </li>
                                        <li><a href="causes-list.php">magazine</a></li>
